      ...
      <section className="relative py-[82px_72px] max-[650px]:py-[58px_54px]">
        <div className={`${ui.container} grid grid-cols-[1.08fr_.92fr] items-center gap-16 max-[980px]:grid-cols-1 max-[980px]:gap-[38px]`}>
          ...
          <div className="reveal relative mx-auto w-full max-w-[700px] rounded-[30px] border border-line bg-[linear-gradient(180deg,rgba(18,39,64,.82),rgba(8,20,34,.86))] p-[18px] shadow-soft ring-1 ring-inset ring-brand/10 [transform:perspective(1000px)_rotateY(-4deg)_rotateX(2deg)] max-[980px]:transform-none">
            ...
            <div className="absolute -right-[22px] top-[20%] animate-float rounded-[14px] border border-line bg-[#0b1728]/95 px-[13px] py-[11px] text-[.82rem] text-[#dce8f3] shadow-[0_14px_35px_rgba(0,0,0,.3)] backdrop-blur-xl max-[650px]:static max-[650px]:mt-3 max-[650px]:animate-none">✓ API & integration ready</div>
            <div className="absolute -left-[26px] bottom-[12%] animate-float rounded-[14px] border border-line bg-[#0b1728]/95 px-[13px] py-[11px] text-[.82rem] text-[#dce8f3] shadow-[0_14px_35px_rgba(0,0,0,.3)] backdrop-blur-xl [animation-delay:-2.3s] max-[650px]:static max-[650px]:mt-2 max-[650px]:animate-none">⚡ Production-focused fixes</div>
          </div>
        </div>
      </section>
